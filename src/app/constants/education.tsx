export const education = [
    {
        ...
        body: [
            ...
            },
            {
                ...
                date: "2014-2018",
                text: `The degree of Computer Engineering, has brought me the knowledge and skills necessary to devise, 
        ...
        body: [
            {
                ...
                date: "2012-2014",
                text: `The general competence of this course is to develop, implement, document and maintain cross-platform 
